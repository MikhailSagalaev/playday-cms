        ...
        $(document).ready(function () {
            const tool_id = 'dab6d62c-143e-4242-9958-9467cdc291b7';
            const block_id = '#rec759480568'.substring(4);
            const block = $('#rec759480568').removeClass('r_hidden').hide();
            ...
            $.post(
                ...
                function (data) {
                    if ('error' in data) {
                        block.text('Collabza error (#rec759480568): ' + data.error);
